    ...
    <div className="app">
      <header className="header">
        ...
        <p className="subtitle">
          Write raw, see clean — live preview as you type
        </p>
      </header>
      ...
      <main className={`main view-${activeTab}`}>
        <div
          className={`panel editor-panel ${activeTab === "preview" ? "hidden" : ""}`}
        >
        ...
        <div
          className={`panel preview-panel ${activeTab === "edit" ? "hidden" : ""}`}
        >
          <div className="panel-header">
            <div className="panel-title">
              <span>Preview</span>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="social-links">
            <a
              href="https://space3dportfolio.netlify.app"
              target="_blank"
            ...
            <a
              href="https://github.com/NipunKachwaha"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
            ...
            <a
              href="https://www.linkedin.com/in/nipun-/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
            ...
            <a
              href="https://www.instagram.com/thakurxnipun/"
              target="_blank"
              rel="noopener noreferrer"
